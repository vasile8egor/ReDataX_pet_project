...
from revolut_app.fx_lab.shared.constants import EPSILON
...
class HamiltonianParameters:
    ...
    def as_dict(self):
        return {
            ...
            'couplings': [
                {
                    'left_currency': coupling.left_currency.value,
                    'right_currency': coupling.right_currency.value,
                    'strength': coupling.strength,
                    'relation_sign': coupling.relation_sign,
                }
