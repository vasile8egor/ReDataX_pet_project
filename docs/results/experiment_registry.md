...
> В документ включаются только воспроизводимые результаты или результаты, для которых сохранён сырой артефакт. Исторические локальные результаты помечаются отдельно.
