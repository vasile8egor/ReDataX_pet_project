...
SELECT
    ...
    b.days
FROM gold.fact_research_policy_metrics AS p FINAL
ANY LEFT JOIN gold.fact_research_bootstrap AS b FINAL
...
ANY LEFT JOIN gold.dim_research_experiment_runs AS r FINAL
...
FROM gold.fact_research_policy_metrics AS m FINAL
INNER JOIN gold.fact_research_policy_metrics AS o FINAL
